class ScoresController < ApplicationController
  def index
    ...
    @scores_in_previous_month = Score.set_scores_in_previous_month(start_date, current_user)
    @scores_in_next_month = Score.set_scores_in_next_month(start_date, current_user)
  end
