class ScoresController < ApplicationController
  def index
    ...
    @scores_in_previous_month = current_user.scores.get_scores_in_previous_month(start_date, current_user)
    @scores_in_next_month = current_user.scores.get_scores_in_next_month(start_date, current_user)
  end
